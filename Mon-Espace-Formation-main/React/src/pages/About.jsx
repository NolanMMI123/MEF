        ...
        <div>
                    ...
                    <div className="align-items-center justify-content-center text-center">
                        <div>
                            ...
                            <p className="lead mb-5 opacity-75" style={{ fontSize: '1.1rem' }}>
                                Votre partenaire de confiance pour la formation professionnelle dans le numérique et les nouvelles technologies
                            </p>
            ...
            <section style={{ padding: '80px 0', backgroundColor: theme.colors.lightGrey }}> {/* Section Notre Histoire */}
                <Container>
                    <Row className="justify-content-center text-center mb-5">
                        <Col lg={7}>
                            <h2 className="fw-bold text-start mb-3"> Notre Histoire </h2>
                        ...
                        <p className='border-1 border-rounded background'>"Former les talents de demain avec les technologies d'aujourd'hui"</p>
                    </Row>
                </Container>
            </section>
            <section style={{ padding: '40px 0' }}> {/* Section Les Fondateurs */}
                <Container>
                    <h1 className='text-center'>Les Fondateurs</h1>
                    <p className='text-center mb-5'>Trois experts passionnés au service de votre montée en compétences</p>
            ...
            <section style={{ padding: '40px 0' }}> {/* Section Nos Valeurs */}
                <Container>
                    ...
                    <p className='text-center mb-5'>Les pilliers qui guident notre action au quotidien</p>
                    <Row className="justify-content-center">
                        <Col lg={3}>
            ...
            <section style={{ padding: '80px 0', backgroundColor: theme.colors.lightGrey }}> {/* Section Pourquoi */}
                <Container>
                    <Row className="justify-content-center text-start mb-5">
                        ...
                        <Col lg={6}>
                            <div>
                                <h2>Pourquoi choisir TXLFORMA ?</h2>
                                <p>Nous avons pensé chaque détail pour vous offrir la meilleure expérience de formation possible :</p>
                                <ul className="list-unstyled">
                                    <li className="mb-3"><span><MdTaskAlt className="me-2" style={{ color: theme.colors.accent }} />Formations 100% en présentiel pour une meilleure interaction</span></li>
                                    <li className="mb-3"><span><MdTaskAlt className="me-2" style={{ color: theme.colors.accent }} />Groupes à effectif réduit pour un apprentissage optimal</span></li>
                                    <li className="mb-3"><span><MdTaskAlt className="me-2" style={{ color: theme.colors.accent }} />Matériel professionnel fourni (PC portables haute performance)</span></li>
                                    <li className="mb-3"><span><MdTaskAlt className="me-2" style={{ color: theme.colors.accent }} />Formateurs experts certifiés et issus du terrain</span></li>
                                    <li className="mb-3"><span><MdTaskAlt className="me-2" style={{ color: theme.colors.accent }} />Suivi pédagogique personnalisé tout au long de la formation</span></li>
                                    <li className="mb-3"><span><MdTaskAlt className="me-2" style={{ color: theme.colors.accent }} />Émargement numérique pour un suivi précis des présences</span></li>
                                    <li className="mb-3"><span><MdTaskAlt className="me-2" style={{ color: theme.colors.accent }} />Attestation de formation délivrée en fin de parcours</span></li>
                                    <li className="mb-3"><span><MdTaskAlt className="me-2" style={{ color: theme.colors.accent }} />Support de cours et ressources pédagogiques inclus</span></li>
                                </ul>
                            </div>
                        </Col>
                    </Row>
            ...
            <section>
                <Container>
                    <h2 className='text-center mb-4'>Nos Domaines d'Expertise</h2>
                    <p className='text-center mb-5'>7 Catégories de formations pour couvrir tous vos besoins en compétences numériques</p>
                    <Row className="justify-content-center">
                        {[
            ...
            <section style={{ backgroundColor: theme.colors.bgFooter, color: 'white', padding: '100px 0 80px 0' }}>
                <Container style={{ textAlign: 'center', marginBottom: '40px' }}>
                    <h1>Prêt à commencer votre formation ?</h1>
                    <p>Rejoignez TXLFORMA et donnez un nouvel élan à votre carrière dans le numérique</p>
                    <div>
                    ...
                    <div className="d-flex flex-column flex-sm-row flex-lg-row align-items-center gap-3 gap-lg-4 mt-5 text-center justify-content-center flex-wrap">
                        <p>
